...
decodeFunctionResult(functionFragment: 'setDomain', data: BytesLike): Result;
    ...
    export namespace DomainRegisteredEvent {
      export type InputTuple = [domain: string, tag: BytesLike, index: BigNumberish];
      export type OutputTuple = [domain: string, tag: string, index: bigint];
      export interface OutputObject {domain: string, tag: string, index: bigint };
  ...
  removeAllListeners<TCEvent extends TypedContractEvent>(event?: TCEvent): Promise<this>
    ...
    getNumberOfDomains: TypedContractMethod<
      [tag: BytesLike, ],
      [bigint],
      'view'
    >
    ...
    getFunction(nameOrSignature: 'getDomain'): TypedContractMethod<
      ...
      'view'
    >;
getFunction(nameOrSignature: 'getDomains'): TypedContractMethod<
      [tag: BytesLike, ],
      [string[]],
      'view'
    >;
getFunction(nameOrSignature: 'getNumberOfDomains'): TypedContractMethod<
      [tag: BytesLike, ],
      [bigint],
      'view'
    >;
