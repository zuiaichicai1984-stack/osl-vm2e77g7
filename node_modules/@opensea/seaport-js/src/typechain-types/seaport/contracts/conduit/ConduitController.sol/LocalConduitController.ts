...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedLogDescription, TypedListener, TypedContractMethod } from "../../../../common.js"
  ...
  export interface LocalConduitControllerInterface extends Interface {
...
decodeFunctionResult(functionFragment: 'updateChannel', data: BytesLike): Result;
    ...
    export namespace NewConduitEvent {
      ...
      export interface OutputObject {conduit: string, conduitKey: string };
    ...
    export namespace OwnershipTransferredEvent {
      export type InputTuple = [conduit: AddressLike, previousOwner: AddressLike, newOwner: AddressLike];
      export type OutputTuple = [conduit: string, previousOwner: string, newOwner: string];
      export interface OutputObject {conduit: string, previousOwner: string, newOwner: string };
      export type Event = TypedContractEvent<InputTuple, OutputTuple, OutputObject>
      export type Filter = TypedDeferredTopicFilter<Event>
      export type Log = TypedEventLog<Event>
      export type LogDescription = TypedLogDescription<Event>
    ...
    export namespace PotentialOwnerUpdatedEvent {
      ...
      export interface OutputObject {newPotentialOwner: string };
      export type Event = TypedContractEvent<InputTuple, OutputTuple, OutputObject>
      export type Filter = TypedDeferredTopicFilter<Event>
      export type Log = TypedEventLog<Event>
      export type LogDescription = TypedLogDescription<Event>
  ...
  export interface LocalConduitController extends BaseContract {
    
    connect(runner?: ContractRunner | null): LocalConduitController;
    waitForDeployment(): Promise<this>;

    interface: LocalConduitControllerInterface;
  ...
  removeAllListeners<TCEvent extends TypedContractEvent>(event?: TCEvent): Promise<this>
    ...
    getChannels: TypedContractMethod<
      [conduit: AddressLike, ],
      [string[]],
      'view'
    >
...
getFunction(nameOrSignature: 'getChannelStatus'): TypedContractMethod<
      ...
      'view'
    >;
getFunction(nameOrSignature: 'getChannels'): TypedContractMethod<
      [conduit: AddressLike, ],
      [string[]],
      'view'
    >;
...
getFunction(nameOrSignature: 'getConduitCodeHashes'): TypedContractMethod<
      ...
      'view'
    >;
getFunction(nameOrSignature: 'getKey'): TypedContractMethod<
      [conduit: AddressLike, ],
      [string],
      'view'
    >;
getFunction(nameOrSignature: 'getPotentialOwner'): TypedContractMethod<
      [conduit: AddressLike, ],
      [string],
      'view'
    >;
getFunction(nameOrSignature: 'getTotalChannels'): TypedContractMethod<
      [conduit: AddressLike, ],
      [bigint],
      'view'
    >;
