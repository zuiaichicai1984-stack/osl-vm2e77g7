...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedLogDescription, TypedListener, TypedContractMethod } from "../../../../common.js"
    ...
    export type ConduitTransferStruct = {itemType: BigNumberish, token: AddressLike, from: AddressLike, to: AddressLike, identifier: BigNumberish, amount: BigNumberish}

    export type ConduitTransferStructOutput = [itemType: bigint, token: string, from: string, to: string, identifier: bigint, amount: bigint] & {itemType: bigint, token: string, from: string, to: string, identifier: bigint, amount: bigint }
  

    export type ConduitBatch1155TransferStruct = {token: AddressLike, from: AddressLike, to: AddressLike, ids: BigNumberish[], amounts: BigNumberish[]}

    export type ConduitBatch1155TransferStructOutput = [token: string, from: string, to: string, ids: bigint[], amounts: bigint[]] & {token: string, from: string, to: string, ids: bigint[], amounts: bigint[] }
  

  export interface LocalConduitInterface extends Interface {
...
decodeFunctionResult(functionFragment: 'updateChannel', data: BytesLike): Result;
    ...
    export namespace ChannelUpdatedEvent {
      ...
      export interface OutputObject {channel: string, open: boolean };
  ...
  export interface LocalConduit extends BaseContract {
    
    connect(runner?: ContractRunner | null): LocalConduit;
    waitForDeployment(): Promise<this>;

    interface: LocalConduitInterface;
  ...
  removeAllListeners<TCEvent extends TypedContractEvent>(event?: TCEvent): Promise<this>
    ...
    executeWithBatch1155: TypedContractMethod<
      [standardTransfers: ConduitTransferStruct[], batchTransfers: ConduitBatch1155TransferStruct[], ],
      [string],
      'nonpayable'
    >
