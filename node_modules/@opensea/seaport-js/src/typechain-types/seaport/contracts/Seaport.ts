...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedLogDescription, TypedListener, TypedContractMethod } from "../../common.js"
    ...
    export type SpentItemStruct = {itemType: BigNumberish, token: AddressLike, identifier: BigNumberish, amount: BigNumberish}

    export type SpentItemStructOutput = [itemType: bigint, token: string, identifier: bigint, amount: bigint] & {itemType: bigint, token: string, identifier: bigint, amount: bigint }
  

    export type ReceivedItemStruct = {itemType: BigNumberish, token: AddressLike, identifier: BigNumberish, amount: BigNumberish, recipient: AddressLike}

    export type ReceivedItemStructOutput = [itemType: bigint, token: string, identifier: bigint, amount: bigint, recipient: string] & {itemType: bigint, token: string, identifier: bigint, amount: bigint, recipient: string }
  

    export type OfferItemStruct = {itemType: BigNumberish, token: AddressLike, identifierOrCriteria: BigNumberish, startAmount: BigNumberish, endAmount: BigNumberish}

    export type OfferItemStructOutput = [itemType: bigint, token: string, identifierOrCriteria: bigint, startAmount: bigint, endAmount: bigint] & {itemType: bigint, token: string, identifierOrCriteria: bigint, startAmount: bigint, endAmount: bigint }
  

    export type ConsiderationItemStruct = {itemType: BigNumberish, token: AddressLike, identifierOrCriteria: BigNumberish, startAmount: BigNumberish, endAmount: BigNumberish, recipient: AddressLike}

    export type ConsiderationItemStructOutput = [itemType: bigint, token: string, identifierOrCriteria: bigint, startAmount: bigint, endAmount: bigint, recipient: string] & {itemType: bigint, token: string, identifierOrCriteria: bigint, startAmount: bigint, endAmount: bigint, recipient: string }
  

    export type OrderParametersStruct = {offerer: AddressLike, zone: AddressLike, offer: OfferItemStruct[], consideration: ConsiderationItemStruct[], orderType: BigNumberish, startTime: BigNumberish, endTime: BigNumberish, zoneHash: BytesLike, salt: BigNumberish, conduitKey: BytesLike, totalOriginalConsiderationItems: BigNumberish}

    export type OrderParametersStructOutput = [offerer: string, zone: string, offer: OfferItemStructOutput[], consideration: ConsiderationItemStructOutput[], orderType: bigint, startTime: bigint, endTime: bigint, zoneHash: string, salt: bigint, conduitKey: string, totalOriginalConsiderationItems: bigint] & {offerer: string, zone: string, offer: OfferItemStructOutput[], consideration: ConsiderationItemStructOutput[], orderType: bigint, startTime: bigint, endTime: bigint, zoneHash: string, salt: bigint, conduitKey: string, totalOriginalConsiderationItems: bigint }
  

    export type OrderComponentsStruct = {offerer: AddressLike, zone: AddressLike, offer: OfferItemStruct[], consideration: ConsiderationItemStruct[], orderType: BigNumberish, startTime: BigNumberish, endTime: BigNumberish, zoneHash: BytesLike, salt: BigNumberish, conduitKey: BytesLike, counter: BigNumberish}

    export type OrderComponentsStructOutput = [offerer: string, zone: string, offer: OfferItemStructOutput[], consideration: ConsiderationItemStructOutput[], orderType: bigint, startTime: bigint, endTime: bigint, zoneHash: string, salt: bigint, conduitKey: string, counter: bigint] & {offerer: string, zone: string, offer: OfferItemStructOutput[], consideration: ConsiderationItemStructOutput[], orderType: bigint, startTime: bigint, endTime: bigint, zoneHash: string, salt: bigint, conduitKey: string, counter: bigint }
    ...
    export type AdvancedOrderStructOutput = [parameters: OrderParametersStructOutput, numerator: bigint, denominator: bigint, signature: string, extraData: string] & {parameters: OrderParametersStructOutput, numerator: bigint, denominator: bigint, signature: string, extraData: string }
  

    export type CriteriaResolverStruct = {orderIndex: BigNumberish, side: BigNumberish, index: BigNumberish, identifier: BigNumberish, criteriaProof: BytesLike[]}

    export type CriteriaResolverStructOutput = [orderIndex: bigint, side: bigint, index: bigint, identifier: bigint, criteriaProof: string[]] & {orderIndex: bigint, side: bigint, index: bigint, identifier: bigint, criteriaProof: string[] }
  

    export type FulfillmentComponentStruct = {orderIndex: BigNumberish, itemIndex: BigNumberish}

    export type FulfillmentComponentStructOutput = [orderIndex: bigint, itemIndex: bigint] & {orderIndex: bigint, itemIndex: bigint }
  

    export type ExecutionStruct = {item: ReceivedItemStruct, offerer: AddressLike, conduitKey: BytesLike}

    export type ExecutionStructOutput = [item: ReceivedItemStructOutput, offerer: string, conduitKey: string] & {item: ReceivedItemStructOutput, offerer: string, conduitKey: string }
  

    export type OrderStruct = {parameters: OrderParametersStruct, signature: BytesLike}

    export type OrderStructOutput = [parameters: OrderParametersStructOutput, signature: string] & {parameters: OrderParametersStructOutput, signature: string }
  

    export type AdditionalRecipientStruct = {amount: BigNumberish, recipient: AddressLike}

    export type AdditionalRecipientStructOutput = [amount: bigint, recipient: string] & {amount: bigint, recipient: string }
  

    export type BasicOrderParametersStruct = {considerationToken: AddressLike, considerationIdentifier: BigNumberish, considerationAmount: BigNumberish, offerer: AddressLike, zone: AddressLike, offerToken: AddressLike, offerIdentifier: BigNumberish, offerAmount: BigNumberish, basicOrderType: BigNumberish, startTime: BigNumberish, endTime: BigNumberish, zoneHash: BytesLike, salt: BigNumberish, offererConduitKey: BytesLike, fulfillerConduitKey: BytesLike, totalOriginalAdditionalRecipients: BigNumberish, additionalRecipients: AdditionalRecipientStruct[], signature: BytesLike}

    export type BasicOrderParametersStructOutput = [considerationToken: string, considerationIdentifier: bigint, considerationAmount: bigint, offerer: string, zone: string, offerToken: string, offerIdentifier: bigint, offerAmount: bigint, basicOrderType: bigint, startTime: bigint, endTime: bigint, zoneHash: string, salt: bigint, offererConduitKey: string, fulfillerConduitKey: string, totalOriginalAdditionalRecipients: bigint, additionalRecipients: AdditionalRecipientStructOutput[], signature: string] & {considerationToken: string, considerationIdentifier: bigint, considerationAmount: bigint, offerer: string, zone: string, offerToken: string, offerIdentifier: bigint, offerAmount: bigint, basicOrderType: bigint, startTime: bigint, endTime: bigint, zoneHash: string, salt: bigint, offererConduitKey: string, fulfillerConduitKey: string, totalOriginalAdditionalRecipients: bigint, additionalRecipients: AdditionalRecipientStructOutput[], signature: string }
  

    export type FulfillmentStruct = {offerComponents: FulfillmentComponentStruct[], considerationComponents: FulfillmentComponentStruct[]}

    export type FulfillmentStructOutput = [offerComponents: FulfillmentComponentStructOutput[], considerationComponents: FulfillmentComponentStructOutput[]] & {offerComponents: FulfillmentComponentStructOutput[], considerationComponents: FulfillmentComponentStructOutput[] }
...
encodeFunctionData(functionFragment: 'fulfillAdvancedOrder', values: [AdvancedOrderStruct, CriteriaResolverStruct[], BytesLike, AddressLike]): string;
encodeFunctionData(functionFragment: 'fulfillAvailableAdvancedOrders', values: [AdvancedOrderStruct[], CriteriaResolverStruct[], FulfillmentComponentStruct[][], FulfillmentComponentStruct[][], BytesLike, AddressLike, BigNumberish]): string;
encodeFunctionData(functionFragment: 'fulfillAvailableOrders', values: [OrderStruct[], FulfillmentComponentStruct[][], FulfillmentComponentStruct[][], BytesLike, BigNumberish]): string;
...
encodeFunctionData(functionFragment: 'matchAdvancedOrders', values: [AdvancedOrderStruct[], CriteriaResolverStruct[], FulfillmentStruct[], AddressLike]): string;
...
decodeFunctionResult(functionFragment: 'validate', data: BytesLike): Result;
    ...
    export namespace CounterIncrementedEvent {
      ...
      export interface OutputObject {newCounter: bigint, offerer: string };
    ...
    export namespace OrderCancelledEvent {
      export type InputTuple = [orderHash: BytesLike, offerer: AddressLike, zone: AddressLike];
      export type OutputTuple = [orderHash: string, offerer: string, zone: string];
      export interface OutputObject {orderHash: string, offerer: string, zone: string };
      export type Event = TypedContractEvent<InputTuple, OutputTuple, OutputObject>
      export type Filter = TypedDeferredTopicFilter<Event>
      export type Log = TypedEventLog<Event>
      export type LogDescription = TypedLogDescription<Event>
    ...
    export namespace OrderFulfilledEvent {
      export type InputTuple = [orderHash: BytesLike, offerer: AddressLike, zone: AddressLike, recipient: AddressLike, offer: SpentItemStruct[], consideration: ReceivedItemStruct[]];
      export type OutputTuple = [orderHash: string, offerer: string, zone: string, recipient: string, offer: SpentItemStructOutput[], consideration: ReceivedItemStructOutput[]];
      export interface OutputObject {orderHash: string, offerer: string, zone: string, recipient: string, offer: SpentItemStructOutput[], consideration: ReceivedItemStructOutput[] };
      export type Event = TypedContractEvent<InputTuple, OutputTuple, OutputObject>
      export type Filter = TypedDeferredTopicFilter<Event>
      export type Log = TypedEventLog<Event>
      export type LogDescription = TypedLogDescription<Event>
    ...
    export namespace OrderValidatedEvent {
      export type InputTuple = [orderHash: BytesLike, orderParameters: OrderParametersStruct];
      export type OutputTuple = [orderHash: string, orderParameters: OrderParametersStructOutput];
      export interface OutputObject {orderHash: string, orderParameters: OrderParametersStructOutput };
      export type Event = TypedContractEvent<InputTuple, OutputTuple, OutputObject>
      export type Filter = TypedDeferredTopicFilter<Event>
      export type Log = TypedEventLog<Event>
      export type LogDescription = TypedLogDescription<Event>
    ...
    export namespace OrdersMatchedEvent {
      ...
      export interface OutputObject {orderHashes: string[] };
      export type Event = TypedContractEvent<InputTuple, OutputTuple, OutputObject>
      export type Filter = TypedDeferredTopicFilter<Event>
      export type Log = TypedEventLog<Event>
      export type LogDescription = TypedLogDescription<Event>
  ...
  removeAllListeners<TCEvent extends TypedContractEvent>(event?: TCEvent): Promise<this>
    ...
    __activateTstore: TypedContractMethod<
      [],
      [void],
      'nonpayable'
    >
    ...
    fulfillAdvancedOrder: TypedContractMethod<
      [arg0: AdvancedOrderStruct, arg1: CriteriaResolverStruct[], fulfillerConduitKey: BytesLike, recipient: AddressLike, ],
      [boolean],
      'payable'
    >
    ...
    fulfillAvailableAdvancedOrders: TypedContractMethod<
      [arg0: AdvancedOrderStruct[], arg1: CriteriaResolverStruct[], arg2: FulfillmentComponentStruct[][], arg3: FulfillmentComponentStruct[][], fulfillerConduitKey: BytesLike, recipient: AddressLike, maximumFulfilled: BigNumberish, ],
    ...
    fulfillAvailableOrders: TypedContractMethod<
      [arg0: OrderStruct[], arg1: FulfillmentComponentStruct[][], arg2: FulfillmentComponentStruct[][], fulfillerConduitKey: BytesLike, maximumFulfilled: BigNumberish, ],
      [[boolean[], ExecutionStructOutput[]]],
      'payable'
    >
    ...
    getOrderStatus: TypedContractMethod<
      [orderHash: BytesLike, ],
      [[boolean, boolean, bigint, bigint] & {isValidated: boolean, isCancelled: boolean, totalFilled: bigint, totalSize: bigint }],
      'view'
    >
    ...
    information: TypedContractMethod<
      [],
      [[string, string, string] & {version: string, domainSeparator: string, conduitController: string }],
      'view'
    >
    ...
    matchAdvancedOrders: TypedContractMethod<
      [arg0: AdvancedOrderStruct[], arg1: CriteriaResolverStruct[], arg2: FulfillmentStruct[], recipient: AddressLike, ],
    ...
    getFunction(nameOrSignature: '__activateTstore'): TypedContractMethod<
      [],
      [void],
      'nonpayable'
    >;
