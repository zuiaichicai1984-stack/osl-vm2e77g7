...
export type SpentItemStructOutput = [itemType: bigint, token: string, identifier: bigint, amount: bigint] & {
    itemType: bigint;
    token: string;
    identifier: bigint;
    amount: bigint;
...
export type ReceivedItemStructOutput = [itemType: bigint, token: string, identifier: bigint, amount: bigint, recipient: string] & {
    itemType: bigint;
    token: string;
    identifier: bigint;
    amount: bigint;
...
export type OfferItemStructOutput = [itemType: bigint, token: string, identifierOrCriteria: bigint, startAmount: bigint, endAmount: bigint] & {
    itemType: bigint;
    token: string;
...
export type ConsiderationItemStructOutput = [itemType: bigint, token: string, identifierOrCriteria: bigint, startAmount: bigint, endAmount: bigint, recipient: string] & {
    itemType: bigint;
    token: string;
    identifierOrCriteria: bigint;
    startAmount: bigint;
...
export type OrderParametersStructOutput = [offerer: string, zone: string, offer: OfferItemStructOutput[], consideration: ConsiderationItemStructOutput[], orderType: bigint, startTime: bigint, endTime: bigint, zoneHash: string, salt: bigint, conduitKey: string, totalOriginalConsiderationItems: bigint] & {
    offerer: string;
    zone: string;
...
export type OrderComponentsStructOutput = [offerer: string, zone: string, offer: OfferItemStructOutput[], consideration: ConsiderationItemStructOutput[], orderType: bigint, startTime: bigint, endTime: bigint, zoneHash: string, salt: bigint, conduitKey: string, counter: bigint] & {
    offerer: string;
    zone: string;
    offer: OfferItemStructOutput[];
    consideration: ConsiderationItemStructOutput[];
...
export type AdvancedOrderStructOutput = [parameters: OrderParametersStructOutput, numerator: bigint, denominator: bigint, signature: string, extraData: string] & {
...
export type CriteriaResolverStructOutput = [orderIndex: bigint, side: bigint, index: bigint, identifier: bigint, criteriaProof: string[]] & {
    orderIndex: bigint;
    side: bigint;
    index: bigint;
    identifier: bigint;
...
export type FulfillmentComponentStructOutput = [orderIndex: bigint, itemIndex: bigint] & {
    orderIndex: bigint;
    itemIndex: bigint;
};
...
export type ExecutionStructOutput = [item: ReceivedItemStructOutput, offerer: string, conduitKey: string] & {
...
export type OrderStructOutput = [parameters: OrderParametersStructOutput, signature: string] & {
    parameters: OrderParametersStructOutput;
    signature: string;
};
...
export type AdditionalRecipientStructOutput = [amount: bigint, recipient: string] & {
    amount: bigint;
    recipient: string;
};
...
export type FulfillmentStructOutput = [offerComponents: FulfillmentComponentStructOutput[], considerationComponents: FulfillmentComponentStructOutput[]] & {
...
export declare namespace OrderCancelledEvent {
    type InputTuple = [orderHash: BytesLike, offerer: AddressLike, zone: AddressLike];
...
export declare namespace OrderFulfilledEvent {
    type InputTuple = [orderHash: BytesLike, offerer: AddressLike, zone: AddressLike, recipient: AddressLike, offer: SpentItemStruct[], consideration: ReceivedItemStruct[]];
    type OutputTuple = [orderHash: string, offerer: string, zone: string, recipient: string, offer: SpentItemStructOutput[], consideration: ReceivedItemStructOutput[]];
    interface OutputObject {
        orderHash: string;
        offerer: string;
        zone: string;
...
export declare namespace OrderValidatedEvent {
    type InputTuple = [orderHash: BytesLike, orderParameters: OrderParametersStruct];
    type OutputTuple = [orderHash: string, orderParameters: OrderParametersStructOutput];
    interface OutputObject {
        orderHash: string;
