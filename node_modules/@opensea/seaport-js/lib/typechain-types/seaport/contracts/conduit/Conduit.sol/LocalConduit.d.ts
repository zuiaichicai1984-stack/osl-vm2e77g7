...
export type ConduitTransferStructOutput = [itemType: bigint, token: string, from: string, to: string, identifier: bigint, amount: bigint] & {
    itemType: bigint;
    token: string;
    from: string;
    to: string;
...
export type ConduitBatch1155TransferStructOutput = [token: string, from: string, to: string, ids: bigint[], amounts: bigint[]] & {
    token: string;
    from: string;
    to: string;
    ids: bigint[];
