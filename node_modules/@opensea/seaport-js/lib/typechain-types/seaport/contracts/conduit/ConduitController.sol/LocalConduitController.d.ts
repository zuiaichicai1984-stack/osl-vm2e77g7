...
export declare namespace OwnershipTransferredEvent {
    type InputTuple = [conduit: AddressLike, previousOwner: AddressLike, newOwner: AddressLike];
    type OutputTuple = [conduit: string, previousOwner: string, newOwner: string];
    interface OutputObject {
        conduit: string;
