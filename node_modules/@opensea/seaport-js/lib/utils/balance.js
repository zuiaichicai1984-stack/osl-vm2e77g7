...
const balanceOf = async (owner, item, provider, criteria) => {
    if ((0, item_1.isErc721Item)(item.itemType)) {
        ...
        const contract = index_1.TestERC1155__factory.connect(item.token, provider);
