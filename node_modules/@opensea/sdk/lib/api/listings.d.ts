...
import { type CreateListingActionsRequest, type CreateListingActionsResponse, type CrossChainFulfillmentRequest, type CrossChainFulfillmentResponse, type GetBestListingResponse, type GetListingsResponse, type SweepCollectionRequest, type SweepCollectionResponse, type TraitFilter } from "./types";
/**
...
export declare class ListingsAPI {
     ...
     */
    getBestListings(collectionSlug: string, limit?: number, next?: string, includePrivateListings?: boolean, traits?: TraitFilter[]): Promise<GetListingsResponse>;
    /**
     ...
     */
    getCrossChainFulfillmentData(request: CrossChainFulfillmentRequest): Promise<CrossChainFulfillmentResponse>;
    /**
     ...
     */
    sweepCollection(request: SweepCollectionRequest): Promise<SweepCollectionResponse>;
    /**
     ...
     * approval graph.
     */
    createListingActions(request: CreateListingActionsRequest): Promise<CreateListingActionsResponse>;
}
