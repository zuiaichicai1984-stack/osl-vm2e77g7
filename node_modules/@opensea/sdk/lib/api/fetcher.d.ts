...
export interface Fetcher {
     ...
     */
    get<T>(apiPath: string, query?: object, options?: RequestOptions): Promise<Camelize<T>>;
    /**
     ...
     * @returns The camelCase view of the API response.
     */
    post<T>(apiPath: string, body?: object, headers?: object, options?: PostOptions): Promise<Camelize<T>>;
}
/** Fetcher used by scoped wallet helpers that need every write verb. */
export interface WalletAuthFetcher extends Fetcher {
    request<T>(method: HttpMethod, apiPath: string, body?: object, headers?: object, options?: PostOptions): Promise<Camelize<T>>;
}
