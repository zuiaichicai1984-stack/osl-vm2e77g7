 ...
 * undefined keys.
 */
export declare function encodeTraitsParam(traits: TraitFilter[] | undefined): string | undefined;
/**
 ...
 * @category API Models
 */
export type Listing = Camelize<Omit<ApiListing, "protocol_data" | "type" | "status">> & {
    protocolData?: ProtocolData;
    type: OrderType;
    status: OrderStatus;
};
 ...
 * @category API Response Types
 */
export type SvmInstructionAccountResponse = Camelize<ApiSvmInstructionAccountResponse>;
/**
 * SVM instruction.
 * @category API Response Types
 */
 ...
 * @category API Response Types
 */
export type SvmTransactionDetailsResponse = Camelize<ApiSvmTransactionDetailsResponse>;
/**
 ...
 * @category API Response Types
 */
export type AgentProfileRelationshipsResponse = Camelize<ApiAgentProfileRelationshipsResponse>;
/**
 ...
 * @category API Response Types
 */
export type GetTrendingTokensResponse = Camelize<Omit<TokenPaginatedResponse, "tokens">> & {
    /** List of {@link Token} */
    tokens: Token[];
};
/**
 ...
 * @category API Response Types
 */
export type GetTopTokensResponse = Camelize<Omit<TokenPaginatedResponse, "tokens">> & {
    /** List of {@link Token} */
    tokens: Token[];
};
/**
 ...
 * @category API Response Types
 */
export type GetTokenResponse = Camelize<Omit<ApiTokenDetailedResponse, "image_url">> & {
    /** URL of the token image (null when the token has no image) */
    imageUrl?: string | null;
};
/**
 ...
 * @category API Models
 */
export type CollectionSearchResult = Camelize<Omit<ApiCollectionSearchResponse, "image_url">> & {
 ...
 * @category API Models
 */
export type TokenSearchResult = Camelize<Omit<ApiTokenSearchResponse, "image_url">> & {
 ...
 * @category API Models
 */
export type NftSearchResult = Camelize<Omit<ApiNftSearchResponse, "image_url" | "name">> & {
 ...
 * @category API Models
 */
export type AccountSearchResult = Camelize<Omit<ApiAccountSearchResponse, "username" | "profile_image_url">> & {
 ...
 * @category API Models
 */
export type SearchResult = Camelize<Omit<ApiSearchResultResponse, "collection" | "token" | "nft" | "account">> & {
 ...
 * @category API Response Types
 */
export type GetAccountTokensResponse = Camelize<Omit<TokenBalancePaginatedResponse, "token_balances">> & {
...
export type CreateListingActionsRequest = Camelize<ApiCreateListingActionsRequest>;
export type CrossChainDropMintRequest = Camelize<ApiCrossChainDropMintRequest>;
export type CrossChainFulfillmentRequest = Camelize<ApiCrossChainFulfillmentRequest>;
...
export type CollectionHoldersPaginatedResponse = Camelize<ApiCollectionHoldersPaginatedResponse>;
export type CollectionOfferAggregatesPaginatedResponse = Camelize<ApiCollectionOfferAggregatesPaginatedResponse>;
export type CreateListingActionsResponse = Camelize<ApiCreateListingActionsResponse>;
export type CrossChainDropMintResponse = Camelize<ApiCrossChainDropMintResponse>;
export type CrossChainFulfillmentResponse = Camelize<ApiCrossChainFulfillmentResponse>;
...
export type PositionTokenTransfersResponse = Camelize<ApiPositionTokenTransfersResponse>;
...
export type TokenActivityWindowStatsResponse = Camelize<ApiTokenActivityWindowStatsResponse>;
...
export type TokenLiquidityPoolsResponse = Camelize<ApiTokenLiquidityPoolsResponse>;
export type TokenSwapActivityPaginatedResponse = Camelize<ApiTokenSwapActivityPaginatedResponse>;
 ...
 * @category API Response Types
 */
export type GetAccountTokenActivityResponse = Camelize<TokenAccountActivityPaginatedResponse>;
/**
